...
# twebserver
if true; then
curl -L -o twebserver-1.47.24.tar.gz --output-dir $BUILD_DIR https://github.com/jerily/twebserver/archive/refs/tags/v1.47.24.tar.gz
tar -xvf $BUILD_DIR/twebserver-1.47.24.tar.gz -C $BUILD_DIR
cd $BUILD_DIR/twebserver-1.47.24
mkdir build
cd build
